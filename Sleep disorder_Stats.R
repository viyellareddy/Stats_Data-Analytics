...
ggplot(sleep_data, aes(x = Gender, fill = factor(Sleep.Disorder))) +
  geom_bar(position = "fill") +
  labs(title = "Distribution of Sleep Disorder by Gender") +
  scale_fill_manual(values = c("0" = "lightgreen", "2" = "purple", "1" = "lightblue"))
...
ggpairs(sleep_data, columns = c(2, 4:7, 10), aes(color = factor(Sleep.Disorder)))
